      ...
      <main className="bg-gray-50">
        ...
        <section className="max-w-7xl mx-auto px-6 py-10">
          ...
          <p className="text-gray-600 mt-3 max-w-2xl">
            Cập nhật xu hướng mới nhất về lập trình và công nghệ để không bao
            giờ bị bỏ lại phía sau trong kỷ nguyên số.
          </p>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-6 grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-gray-500 mt-4">15 Tháng 5, 2026</p>
            ...
            <p className="text-gray-600 mt-2">
              Khám phá cách các hệ thống AI đang chuyển mình từ việc tạo nội
              dung sang thực hiện các nhiệm vụ phức tạp một cách độc lập trong
        ...
        <section className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-3 gap-8">
          {[
            ...
            >
              ...
              <p className="text-sm text-gray-500">Đọc thêm →</p>
            </Link>
          ))}
        </section>
