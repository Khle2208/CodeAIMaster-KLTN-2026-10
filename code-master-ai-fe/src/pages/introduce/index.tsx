          ...
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold mt-6 leading-tight">
                Cách mạng hóa <br />
                việc học <span className="text-brand-500">Lập trình</span> với
                AI
              </h1>
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              ...
              <p className="text-gray-600">
                ...
                mọi người thông qua công nghệ hiện đại. Chúng tôi tin rằng bất
                kì ai cũng có thể trở thành lập trình viên giỏi nếu có phương
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              ...
              <p className="text-gray-600">
                Trở thành hệ sinh thái đào tạo công nghệ hàng đầu ứng dụng AI
                tại Việt Nam, kiến tạo thế hệ nhân sự chất lượng cao cho thị
                trường toàn cầu.
              </p>
            </div>
          </div>
            ...
            {[
              ...
              >
                ...
                <div className="w-12 h-12 bg-brand-100 rounded-lg mx-auto mb-4 flex items-center justify-center">
                  <span className="text-brand-500 text-2xl">{item.icon}</span>
                </div>
